        ...
        if message.reply_to_message:
            ...
            for chat_id in query:
                try:
                    ...
                    blocked += 1   # just count
                except InputUserDeactivated:
                    deleted += 1   # just count
...
<b>Unsuccessful :</b> <code>{unsuccessful}</code><blockquote>"""
            ...
            msg = await message.reply("⚠️ Use this command as a reply to any Telegram message.")
...
async def pin_bdcst_text(client, message):
    ...
    if user_id in admin_ids:
        if message.reply_to_message:
            ...
            pls_wait = await message.reply("<blockquote><i>Broadcasting & Pinning Message.. This will Take Some Time</i></blockquote>")
            ...
            status = f"""<blockquote><b><u>Pinned Broadcast Completed</u></b></blockquote>
