        ...
        if messages:
            if client.auto_del > 0:
                ...
                k = await client.send_message(chat_id=message.from_user.id, 
                                          text =(
                f'<b><i>This File is deleting automatically in {humanize.naturaldelta(client.auto_del)}. '
                f'Forward in your Saved Messages..!</i></b><br>'
                f'<b><i>📢 Join: <a href="https://t.me/Animes2u">@Animes2u</a></i></b><br>'
                f'<b><i>💬 Chat: <a href="https://t.me/WeebChat2u">@WeebChat2u</a></i></b>'
            ),
            parse_mode="html"
        )
