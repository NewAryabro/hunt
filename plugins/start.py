        ...
        if messages:
            if client.auto_del > 0:
                ...
                k = await client.send_message(chat_id=message.from_user.id, 
                                          text = f'<blockquote><b><i>This File is deleting automatically in {humanize.naturaldelta(client.auto_del)}. Forward in your Saved Messages..!</i></b><br><b><i>📢 Join: <a href="https://t.me/Animes2u">@Animes2u</a></i></b><br><b><i>💬 Chat: <a href="https://t.me/WeebChat2u">@WeebChat2u</a></i></b></blockquote>'
