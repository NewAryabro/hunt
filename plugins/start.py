        ...
        if messages:
            if client.auto_del > 0:
                ...
                k = await client.send_message(chat_id=message.from_user.id, 
                                          text=f'<blockquote><b><i>This File is deleting automatically in {humanize.naturaldelta(client.auto_del)}. Forward in your Saved Messages..! 💬 𝗖𝗵𝗮𝘁: WeebChat2u </i></b></blockquote>')
